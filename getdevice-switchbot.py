...
def get_device_list(token: str, timestamp: int, sign: str, nonce: str) -> dict:
    """
    SwitchBotデバイスの一覧を取得する
    ...
    API_BASE_URL = "https://api.switch-bot.com/v1.1/devices"
    HTTP_OK = 200
...
if __name__ == "__main__":
    ...
    #request
    try:
        devices = get_device_list(switchbot_token, timestamp, signature, nonce)
